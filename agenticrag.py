...
def get_answer_from_query(query, vector_store, agent_type):
    ...
    print(f"Agent ({agent_type}) is retrieving an answer for query: {query}")
    ...
    if not os.path.isfile(pdf_file_path):
        ...
        try:
            ...
            while True:
                ...
                agent_type = classify_question(query)
                answer = get_answer_from_query(query, vector_store, agent_type)
                print(f"Answer ({agent_type} agent): {answer}")
