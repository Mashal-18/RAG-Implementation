...
def save_history(history, file_path="question_history.json"):
    """Saves the question history to a JSON file."""
...
if __name__ == "__main__":
    ...
    question_history = []  # To store questions and answers
    ...
    if not os.path.isfile(pdf_file_path):
        ...
        try:
            ...
            while True:
                ...
                if query.lower() == "exit":
                    print("Exiting the program. Saving history...")
                ...
                question_history.append({"question": query, "answer": answer})
